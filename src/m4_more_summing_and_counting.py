...
def run_test_count_cosines_from():
    ...
    # -------------------------------------------------------------------------
    expected = 2
    answer = count_cosines_from(1, 6, 0.5)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 5
    answer = count_cosines_from(0, 10, 0.1)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(10, 15, 0.29)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 40
    answer = count_cosines_from(3, 100, 0.29)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(15, 20, 0.5)
